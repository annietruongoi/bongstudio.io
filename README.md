...
# bongstudio68.github.io (MXD-conform scaffold)

- GA4: **G-550F47VKPR** (loaded via `/assets/js/analytics.js`, placed **before** affiliate script)
...
- Canonical: tuyệt đối (`https://bongstudio68.github.io`), JSON-LD Product trên `g.html?sku=`.
...
## Deploy
1. Tạo repo **bongstudio68.github.io** (Public).
2. Upload toàn bộ file trong ZIP vào root, commit.
3. Truy cập **https://bongstudio68.github.io**.
